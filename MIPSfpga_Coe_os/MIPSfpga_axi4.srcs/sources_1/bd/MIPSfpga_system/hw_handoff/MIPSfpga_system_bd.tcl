...
proc write_mig_file_MIPSfpga_system_mig_7series_0_0 { str_mig_prj_filepath } {
   ...
   puts $mig_prj_file {    <ModuleName>MIPSfpga_system_mig_7series_0_0</ModuleName>}
...
# End of write_mig_file_MIPSfpga_system_mig_7series_0_0()
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set BLUE_UART_RXD_OUT [ create_bd_port -dir O BLUE_UART_RXD_OUT ]
  set BLUE_UART_TXD_IN [ create_bd_port -dir I BLUE_UART_TXD_IN ]
  set CLK100MHZ [ create_bd_port -dir I CLK100MHZ ]
  set CPU_RESETN [ create_bd_port -dir I CPU_RESETN ]
  set DIR_clk [ create_bd_port -dir O DIR_clk ]
  ...
  set PWM_B_L [ create_bd_port -dir O PWM_B_L ]
  set PWM_B_R [ create_bd_port -dir O PWM_B_R ]
  set PWM_F_L [ create_bd_port -dir O PWM_F_L ]
  set PWM_F_R [ create_bd_port -dir O PWM_F_R ]
  set UART_RXD_OUT [ create_bd_port -dir O UART_RXD_OUT ]
  set UART_TXD_IN [ create_bd_port -dir I UART_TXD_IN ]

  # Create instance: Car_Driver_Int_0, and set properties
  set Car_Driver_Int_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:Car_Driver_Int:1.0 Car_Driver_Int_0 ]

  # Create instance: MIPS_MicroAptiv_UP_0, and set properties
  set MIPS_MicroAptiv_UP_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:MIPS_MicroAptiv_UP:1.0 MIPS_MicroAptiv_UP_0 ]

  # Create instance: PWM_B_L, and set properties
  set PWM_B_L [ create_bd_cell -type ip -vlnv xilinx.com:user:PWM:1.0 PWM_B_L ]

  # Create instance: PWM_B_R, and set properties
  set PWM_B_R [ create_bd_cell -type ip -vlnv xilinx.com:user:PWM:1.0 PWM_B_R ]

  # Create instance: PWM_F_L, and set properties
  set PWM_F_L [ create_bd_cell -type ip -vlnv xilinx.com:user:PWM:1.0 PWM_F_L ]

  # Create instance: PWM_F_R, and set properties
  set PWM_F_R [ create_bd_cell -type ip -vlnv xilinx.com:user:PWM:1.0 PWM_F_R ]
  ...
  set_property -dict [ list CONFIG.NUM_MI {11}  ] $axi_interconnect_0
  ...
  set_property -dict [ list CONFIG.Byte_Size {9} CONFIG.Coe_File {../../../../new/ram_init_os.coe} CONFIG.Enable_32bit_Address {false} CONFIG.Load_Init_File {true} CONFIG.Register_PortA_Output_of_Memory_Primitives {false} CONFIG.Use_Byte_Write_Enable {false} CONFIG.Use_RSTA_Pin {false} CONFIG.use_bram_block {Stand_Alone}  ] $blk_mem_gen_0
...
CONFIG.USE_LOCKED {false} CONFIG.USE_RESET {false} \
  ...
  set_property -dict [ list CONFIG.C_BUF_TYPE {BUFG} CONFIG.C_SIZE {1}  ] $util_ds_buf_0
  ...
  set_property -dict [ list CONFIG.NUM_PORTS {12}  ] $xlconcat_1
  ...
  connect_bd_intf_net -intf_net MIPS_MicroAptiv_UP_0_AHB_Lite [get_bd_intf_pins MIPS_MicroAptiv_UP_0/AHB_Lite] [get_bd_intf_pins ahblite_axi_bridge_0/AHB_INTERFACE]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M04_AXI [get_bd_intf_pins PWM_B_R/S00_AXI] [get_bd_intf_pins axi_interconnect_0/M04_AXI]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M07_AXI [get_bd_intf_pins PWM_F_L/S00_AXI] [get_bd_intf_pins axi_interconnect_0/M07_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M08_AXI [get_bd_intf_pins PWM_F_R/S00_AXI] [get_bd_intf_pins axi_interconnect_0/M08_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M09_AXI [get_bd_intf_pins PWM_B_L/S00_AXI] [get_bd_intf_pins axi_interconnect_0/M09_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M10_AXI [get_bd_intf_pins Car_Driver_Int_0/S00_AXI] [get_bd_intf_pins axi_interconnect_0/M10_AXI]
  connect_bd_intf_net -intf_net mig_7series_0_DDR2 [get_bd_intf_ports DDR2_SDRAM] [get_bd_intf_pins mig_7series_0/DDR2]

  # Create port connections
  connect_bd_net -net Car_Driver_Int_0_DIR_clk [get_bd_ports DIR_clk] [get_bd_pins Car_Driver_Int_0/DIR_clk]
  connect_bd_net -net Car_Driver_Int_0_DIR_enable [get_bd_ports DIR_enable] [get_bd_pins Car_Driver_Int_0/DIR_enable]
  connect_bd_net -net Car_Driver_Int_0_DIR_latch [get_bd_ports DIR_latch] [get_bd_pins Car_Driver_Int_0/DIR_latch]
  connect_bd_net -net Car_Driver_Int_0_DIR_serial [get_bd_ports DIR_serial] [get_bd_pins Car_Driver_Int_0/DIR_serial]
  ...
  connect_bd_net -net MIPS_MicroAptiv_UP_0_HCLK [get_bd_pins Car_Driver_Int_0/s00_axi_aclk] [get_bd_pins MIPS_MicroAptiv_UP_0/HCLK] [get_bd_pins PWM_B_L/s00_axi_aclk] [get_bd_pins PWM_B_R/s00_axi_aclk] [get_bd_pins PWM_F_L/s00_axi_aclk] [get_bd_pins PWM_F_R/s00_axi_aclk] [get_bd_pins ahblite_axi_bridge_0/s_ahb_hclk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/M05_ACLK] [get_bd_pins axi_interconnect_0/M06_ACLK] [get_bd_pins axi_interconnect_0/M07_ACLK] [get_bd_pins axi_interconnect_0/M08_ACLK] [get_bd_pins axi_interconnect_0/M09_ACLK] [get_bd_pins axi_interconnect_0/M10_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_uart16550_0/s_axi_aclk] [get_bd_pins axi_uart16550_1/s_axi_aclk]
  connect_bd_net -net MIPS_MicroAptiv_UP_0_HRESETn [get_bd_pins Car_Driver_Int_0/s00_axi_aresetn] [get_bd_pins MIPS_MicroAptiv_UP_0/HRESETn] [get_bd_pins PWM_B_L/s00_axi_aresetn] [get_bd_pins PWM_B_R/s00_axi_aresetn] [get_bd_pins PWM_F_L/s00_axi_aresetn] [get_bd_pins PWM_F_R/s00_axi_aresetn] [get_bd_pins ahblite_axi_bridge_0/s_ahb_hresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M04_ARESETN] [get_bd_pins axi_interconnect_0/M05_ARESETN] [get_bd_pins axi_interconnect_0/M06_ARESETN] [get_bd_pins axi_interconnect_0/M07_ARESETN] [get_bd_pins axi_interconnect_0/M08_ARESETN] [get_bd_pins axi_interconnect_0/M09_ARESETN] [get_bd_pins axi_interconnect_0/M10_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_uart16550_0/s_axi_aresetn] [get_bd_pins axi_uart16550_1/s_axi_aresetn] [get_bd_pins mig_7series_0/aresetn]
  connect_bd_net -net PWM_0_Interrupt_out [get_bd_pins PWM_F_L/Interrupt_out] [get_bd_pins xlconcat_1/In9]
  connect_bd_net -net PWM_0_pwm_out [get_bd_ports PWM_F_L] [get_bd_pins PWM_F_L/pwm_out]
  connect_bd_net -net PWM_B_L_Interrupt_out [get_bd_pins PWM_B_L/Interrupt_out] [get_bd_pins xlconcat_1/In11]
  connect_bd_net -net PWM_B_L_pwm_out [get_bd_ports PWM_B_L] [get_bd_pins PWM_B_L/pwm_out]
  connect_bd_net -net PWM_B_R_Interrupt_out [get_bd_pins PWM_B_R/Interrupt_out] [get_bd_pins xlconcat_1/In4]
  connect_bd_net -net PWM_B_R_pwm_out [get_bd_ports PWM_B_R] [get_bd_pins PWM_B_R/pwm_out]
  connect_bd_net -net PWM_F_R_Interrupt_out [get_bd_pins PWM_F_R/Interrupt_out] [get_bd_pins xlconcat_1/In10]
  connect_bd_net -net PWM_F_R_pwm_out [get_bd_ports PWM_F_R] [get_bd_pins PWM_F_R/pwm_out]
  ...
  connect_bd_net -net axi_uart16550_1_ip2intc_irpt [get_bd_pins axi_uart16550_1/ip2intc_irpt] [get_bd_pins xlconcat_1/In8]
  connect_bd_net -net axi_uart16550_1_sout [get_bd_ports BLUE_UART_RXD_OUT] [get_bd_pins axi_uart16550_1/sout]
  ...
  connect_bd_net -net sin_2 [get_bd_ports BLUE_UART_TXD_IN] [get_bd_pins axi_uart16550_1/sin]
  ...
  connect_bd_net -net xlconstant_1_dout1 [get_bd_pins xlconcat_1/In0] [get_bd_pins xlconcat_1/In1] [get_bd_pins xlconcat_1/In2] [get_bd_pins xlconcat_1/In3] [get_bd_pins xlconcat_1/In6] [get_bd_pins xlconcat_1/In7] [get_bd_pins xlconstant_4/dout]
  ...
  connect_bd_net -net xlconstant_5_dout [get_bd_pins axi_uart16550_1/freeze] [get_bd_pins xlconstant_5/dout]

  # Create address segments
  create_bd_addr_seg -range 0x10000 -offset 0x10700000 [get_bd_addr_spaces MIPS_MicroAptiv_UP_0/AHB_Lite] [get_bd_addr_segs Car_Driver_Int_0/S00_AXI/S00_AXI_reg] SEG_Car_Driver_Int_0_S00_AXI_reg
  create_bd_addr_seg -range 0x10000 -offset 0x10E00000 [get_bd_addr_spaces MIPS_MicroAptiv_UP_0/AHB_Lite] [get_bd_addr_segs PWM_B_L/S00_AXI/S00_AXI_reg] SEG_PWM_B_L_S00_AXI_reg
  create_bd_addr_seg -range 0x10000 -offset 0x10F00000 [get_bd_addr_spaces MIPS_MicroAptiv_UP_0/AHB_Lite] [get_bd_addr_segs PWM_B_R/S00_AXI/S00_AXI_reg] SEG_PWM_B_R_S00_AXI_reg
  create_bd_addr_seg -range 0x10000 -offset 0x10C00000 [get_bd_addr_spaces MIPS_MicroAptiv_UP_0/AHB_Lite] [get_bd_addr_segs PWM_F_L/S00_AXI/S00_AXI_reg] SEG_PWM_F_L_S00_AXI_reg
  create_bd_addr_seg -range 0x10000 -offset 0x10D00000 [get_bd_addr_spaces MIPS_MicroAptiv_UP_0/AHB_Lite] [get_bd_addr_segs PWM_F_R/S00_AXI/S00_AXI_reg] SEG_PWM_F_R_S00_AXI_reg
  create_bd_addr_seg -range 0x2000 -offset 0x1FC00000 [get_bd_addr_spaces MIPS_MicroAptiv_UP_0/AHB_Lite] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
  create_bd_addr_seg -range 0x10000 -offset 0x10600000 [get_bd_addr_spaces MIPS_MicroAptiv_UP_0/AHB_Lite] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] SEG_axi_gpio_0_Reg
  create_bd_addr_seg -range 0x10000 -offset 0x10200000 [get_bd_addr_spaces MIPS_MicroAptiv_UP_0/AHB_Lite] [get_bd_addr_segs axi_intc_0/s_axi/Reg] SEG_axi_intc_0_Reg
  create_bd_addr_seg -range 0x10000 -offset 0x10400000 [get_bd_addr_spaces MIPS_MicroAptiv_UP_0/AHB_Lite] [get_bd_addr_segs axi_uart16550_0/S_AXI/Reg] SEG_axi_uart16550_0_Reg
  create_bd_addr_seg -range 0x10000 -offset 0x10500000 [get_bd_addr_spaces MIPS_MicroAptiv_UP_0/AHB_Lite] [get_bd_addr_segs axi_uart16550_1/S_AXI/Reg] SEG_axi_uart16550_1_Reg
  create_bd_addr_seg -range 0x8000000 -offset 0x0 [get_bd_addr_spaces MIPS_MicroAptiv_UP_0/AHB_Lite] [get_bd_addr_segs mig_7series_0/memmap/memaddr] SEG_mig_7series_0_memaddr
